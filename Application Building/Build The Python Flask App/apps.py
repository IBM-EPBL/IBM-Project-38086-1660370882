...
def predict():
    if request.method == 'POST':
        ...
        for i in labels:
            ...
            mapper[i].classes_ = np.load(str('./Model Building/classes'+i+'.npy'),allow_pickle=True)
